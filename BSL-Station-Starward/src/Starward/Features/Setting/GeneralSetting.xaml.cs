...
public sealed partial class GeneralSetting : PageBase
{
    ...
    public bool BslIsGameSelectorPinned
    {
        get; set
        {
            if (SetProperty(ref field, value))
            {
                AppConfig.BslIsGameSelectorPinned = value;
                WeakReferenceMessenger.Default.Send(new BslGameSelectorPinnedChangedMessage(value));
            }
        }
    } = AppConfig.BslIsGameSelectorPinned;
    ...
    public bool EnableBannerAndPost
    {
        get; set
        {
            if (SetProperty(ref field, value))
            {
                ...
                OnPropertyChanged(nameof(DisableGameNoticeRedHot));
            }
        }
