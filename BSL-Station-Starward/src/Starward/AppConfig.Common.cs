...
public static partial class AppConfig
{
    ...
    public const string ProductName = "BSL-Station";

    public const string ProductFolderName = "BSL-Station";
    ...
    public static string StarwardExecutePath => Environment.ProcessPath ?? Path.Combine(AppContext.BaseDirectory, "BSL-Station.exe");
